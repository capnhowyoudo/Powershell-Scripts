...
<#
This PowerShell script is designed to inventory all enabled Windows Server machines from Active Directory (AD) 
and determine whether each one is a virtual or physical machine. 
It then exports the results to a CSV file for reporting or auditing.
#>
