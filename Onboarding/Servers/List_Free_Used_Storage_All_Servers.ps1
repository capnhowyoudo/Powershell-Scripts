<#
Description
This PowerShell script is designed to generate a disk space report for all Windows Server machines that are enabled in Active Directory (AD). 
It remotely connects to each server, gathers information about its local disks, and then summarizes total, used, and free disk space—optionally exporting the results to a CSV file.
#>
