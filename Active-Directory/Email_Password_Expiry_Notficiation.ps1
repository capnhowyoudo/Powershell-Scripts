...
.DESCRIPTION
   ...
   Alternativley you can visit Robert Pearman's youtube channel, https://www.youtube.com/robtitlerequired
...
.EXAMPLE
  Email_Password_Expiry_Notficiation.ps1 -smtpServer mail.domain.com -expireInDays 21 -from "IT Support <support@domain.com>" -Logging -LogPath "c:\logFiles" -testing -testRecipient support@domain.com
...
.EXAMPLE
  Email_Password_Expiry_Notficiation.ps1 -smtpServer mail.domain.com -expireInDays 21 -from "IT Support <support@domain.com>" -reportTo myaddress@domain.com -interval 1,2,5,10,15
