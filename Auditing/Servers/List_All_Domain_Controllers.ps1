<#
This PowerShell script is used to generate a report of all Domain Controllers (DCs) in an Active Directory environment and export the details to a CSV file for documentation or auditing purposes.
#>
