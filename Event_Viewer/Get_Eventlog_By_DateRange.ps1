...
.EXAMPLE
.\Get_Eventlog_By_DateRange.ps1
Uses the default path
.EXAMPLE
.\Get_Eventlog_By_DateRange.ps1 -ExportFolderPath c:\MyFolderExport
Export the results to c:\MyFolderExport
.EXAMPLE
.\Get_Eventlog_By_DateRange.ps1 -IncludeSecurityLog
The security log will be included in the results
.EXAMPLE
.\Get_Eventlog_By_DateRange.ps1 -StartDate "01/01/2019 08:00:00" -EndDate "01/01/2019 09:00:00"
